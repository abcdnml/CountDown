...
public class SystemUtils
{
    ...
    {
        ((InputMethodManager) CountDownApplication.getApplication().getSystemService(Context.INPUT_METHOD_SERVICE))
...
//       inputmanger.hideSoftInputFromWindow(view.getWindowToken(),0);
    ...
    public static int getStatusBarHeight()
    {
        ...
        if (CountDownApplication.getApplication() == null)
        {
            return 0;
        }
        Class<?> c;
        ...
        try
        {
            ...
            barHeight = CountDownApplication.getApplication().getResources().getDimensionPixelSize(x);
        } catch (Exception e1)
        {
